...
var surveyKey = localStorage.getItem('surveyKey');
        ...
        .then(function () {
            ...
            $('#test_datatable tbody').on('click', 'tr', function () {
                ...
                if (table.row('.selected').data().status == "Girildi") {
                    ...
                    location.href = "moxo_result_add?id=" + urlStd + "&ref=" + urlTest + "&ts=" + urlTS + "&sub=" + ts_variable + "&sr=" + str_variable;
                } else {
                    location.href = "moxo_result_add?id=" + urlStd + "&ref=" + urlTest + "&ts=" + urlTS + "&sub=" + ts_variable;
                }
            });
    ...
    if (urlSub != null) {
        $.ajax({//teststudent/{test_student_ref}/tests/{tests_ref}/sub/{ref}/ref
            url: "/subtest/teststudent/" + urlTS + "/tests/" + urlTest + "/sub/" + urlSub + "/ref/"+ surveyKey,
            method: "GET",
        })
            .done(function (data, textStatus, jqXHR) {
                teststd = data;
    ...
    if (urlSR != null) {
        $.ajax({//subtest/{sub_test_ref}/list
            url: "/subtestresult/subtest/" + urlSub + "/list/"+surveyKey,
            method: "GET",
        })
            .done(function (data, textStatus, jqXHR) {
                subtestresult = data;
