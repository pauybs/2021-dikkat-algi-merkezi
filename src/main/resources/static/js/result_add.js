$(document).ready(function () {
    ...
    $('#subTestAddBtn').click(function () {
        ...
        $.ajax({////teststudent/{test_student_ref}/tests/{tests_ref}/add
            ...
            .then(function () {
                window.location.href = "result_add?id=" + urlStd + "&ref=" + urlTest + "&ts=" + urlTS;
            })
    })
     ...
     */
            ...
            $('#test_datatable tbody').on('click', 'tr', function () {
                ...
                if (table.row('.selected').data().status == "Girildi") {
                    ...
                    location.href = "result_add?id=" + urlStd + "&ref=" + urlTest + "&ts=" + urlTS + "&sub=" + ts_variable + "&sr=" + str_variable;
                } else {
                    location.href = "result_add?id=" + urlStd + "&ref=" + urlTest + "&ts=" + urlTS + "&sub=" + ts_variable;
                }
            });
    ...
    $('#testResultAddBtn').click(function () {
        ...
        if (urlSR != null) {
            ...
            $.ajax({///subtest/{sub_test}/ref/{ref}/put
                url: "/subtestresult/subtest/" + urlSub + "/ref/" + urlSR + "/put/"+surveyKey,
                type: "PUT",
                data: obj,
                xhrFields: {
                    withCredentials: true
